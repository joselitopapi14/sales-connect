        ...
        >
          ...
          <div
            className={cn(
              ...
              "w-full", // Full width instead of max-w-7xl
            )}
          >
  ...
  return (
    <>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="relative z-10 flex h-80 w-full flex-col items-start justify-start overflow-hidden rounded-3xl bg-gray-100 md:h-96 dark:bg-neutral-900"
        style={{ flexBasis: "calc(25% - 12px)", minWidth: "250px" }}
      >
